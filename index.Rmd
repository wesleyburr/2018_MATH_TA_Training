...
* You are represented by a union (<a href="http://cupe3908.org/unit2.php">CUPE3908</a>)
* Issues!
...
<br>
* Marking assignments (typical for UTAs)
...
* Use a marking scheme (should be provided by instructor)
...
* Mark all papers' Question 1, then all Question 2, ...
...
* one hour of paid prep time for each week of tutorials in the same class
...
## The Purpose of a Tutorial/Workshop/Seminar
...
* More free-form
* Be prepared for blank states and no input
* Can solve a pre-prepared question solo
* Interaction is key!
...
We're going to use Calculus as our working example, because everyone is familiar with the topic.

* Topic in the course this week is the product rule for differentiation
